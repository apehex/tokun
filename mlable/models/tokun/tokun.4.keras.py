...
for __l, __s in TOKENS[1].items():
    ...
    __token_x = tf.one_hot(indices=_mmtp._tokenize_scalar(text=''.join(__s), layer_count=2, group_size=4, flatten=True), depth=256, axis=-1)
    # embed
