...
class ByteTokenizer(transformers.PreTrainedTokenizer):
    def __init__(self, **kwargs) -> None:
        ...
        # special tokens
        __kwargs['bos_token'] = kwargs.get('bos_token', '\u0002')
        __kwargs['eos_token'] = kwargs.get('eos_token', '\u0003')
        __kwargs['unk_token'] = kwargs.get('unk_token', '\u001a')
        __kwargs['sep_token'] = kwargs.get('sep_token', '\u001d')
        __kwargs['pad_token'] = kwargs.get('pad_token', '\u0000')
        __kwargs['cls_token'] = kwargs.get('cls_token', '\u0011')
        # defaults
    ...
    def _tokenize(self, text: str, **kwargs) -> list:
        return list(chr(__b) for __b in text.encode('utf-32-be'))
    ...
    def convert_tokens_to_string(self, tokens: iter) -> str:
        return bytes(ord(__c) for __c in tokens).decode('utf-32-be')
