...
def random_dataset(sample_count: int, sample_size: int, lower_plane: int=0, upper_plane: int=0x40000, binary: bool=False, dtype: tf.dtypes.DType=tf.int32) -> tf.data.Dataset:
